...
public class SecondarySortedMapReduce extends Configured implements Tool {
	//map class
...
//		job.setNumReduceTasks(tasks);
	...
	public static void main(String[] args) throws Exception {
		args = new String[]{
				...
				"hdfs://hadoop-senior.carmon.com:8020/user/dong/output/mapreduce/secondary/output07"
		};
