...
public class WordCountLocal {
    public static void main(String[] args){
        ...
        final JavaPairRDD<String, Integer> wordCounts = pairs.reduceByKey((Function2<Integer, Integer, Integer>) (v1, v2) -> v1 + v2);
         ...
         */
        wordCounts.foreach((VoidFunction<Tuple2<String, Integer>>) wordCount -> System.out.println(wordCount._1 + "\t => " + wordCount._2()));
