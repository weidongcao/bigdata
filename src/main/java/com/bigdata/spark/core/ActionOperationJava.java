...
public class ActionOperationJava {
    ...
    private static void countByKey() {
        ...
        List<Tuple2<String, String>> original = Arrays.asList(
                new Tuple2<String, String>("class1", "dong"),
                new Tuple2<String, String>("class2", "carmon"),
                new Tuple2<String, String>("class1", "poem"),
                new Tuple2<String, String>("class2", "ling"),
                new Tuple2<String, String>("class1", "kang")
        );
         ...
         */
        Map<String, Object> stuCount = stu.countByKey();

        for (Map.Entry<String, Object> stc : stuCount.entrySet()) {
